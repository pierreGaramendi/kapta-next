    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-cyan-500 rounded-lg flex items-center justify-center text-white font-bold text-xl">K</div>
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link className="hover:text-cyan-400 transition-colors" href="#testimonials">
            Testimonials
          </Link>
        </nav>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-800 p-8 rounded-lg border border-gray-700">
                ...
                <button className="w-full bg-cyan-500 hover:bg-cyan-600 text-white transition-colors">Get Started</button>
              </div>
              <div className="bg-gray-800 p-8 rounded-lg border border-cyan-500">
                <h3 className="text-xl font-semibold mb-4">Pro</h3>
                <p className="text-3xl font-bold mb-6">
                  $12<span className="text-xl font-normal text-gray-400">/user/month</span>
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center">
                    <FaCheckCircle className="text-cyan-400 w-5 h-5 mr-2" />
                ...
                <button className="w-full bg-cyan-500 hover:bg-cyan-600 text-white transition-colors">Start Free Trial</button>
              </div>
              <div className="bg-gray-800 p-8 rounded-lg border border-gray-700">
                ...
                <button className="w-full bg-cyan-500 hover:bg-cyan-600 text-white transition-colors">Contact Sales</button>
              </div>
            </div>
          </div>
        </section>
