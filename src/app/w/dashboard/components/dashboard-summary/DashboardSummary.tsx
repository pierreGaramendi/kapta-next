...
export const DashboardSummary = () => {
  ...
  return (
    <div className="rounded flex flex-row mt-2">

      <div className="mr-2 rounded flex flex-col w-full justify-center p-4 bg-zinc-900">
      ...
      <div className="mr-2 rounded flex flex-col w-full p-4 bg-zinc-900">
        <span>Assigens Tasks</span>
        <span className="font-bold text-2xl">45.45</span>
      </div>

      <div className="rounded flex flex-col w-full p-4 bg-zinc-900">
